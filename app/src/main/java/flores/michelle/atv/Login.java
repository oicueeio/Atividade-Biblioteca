...
public class Login extends AppCompatActivity {
    ...
    final private Integer RC_SIGN_IN = 1001;
    ...
    private void updateUI(FirebaseUser account) {
        final Intent books = new Intent(this, MainActivity.class);
        (Toast.makeText(getApplicationContext(), "Olá" + account.getDisplayName(), Toast.LENGTH_LONG)).show();
        finishAffinity();
        startActivity(books);
    }
